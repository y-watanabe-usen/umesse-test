...
module.exports = function (proto) {
  ...
  proto.createCommand = function (process, index, volume, num, div) {
    const command = {
      ...
      aroundsilent: `areverse[revers];[revers]silenceremove=start_periods=1:start_duration=1:start_threshold=-90dB:detection=peak[silent];[silent]areverse[revers];[revers]silenceremove=start_periods=1:start_duration=1:start_threshold=-90dB:detection=peak`,
