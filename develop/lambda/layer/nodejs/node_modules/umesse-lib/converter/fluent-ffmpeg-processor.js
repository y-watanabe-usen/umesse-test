...
module.exports = function (proto) {
  ...
  proto.generateCm = async function (
    ...
    if (has.endChime) {
      ...
      extra.push(
        this.createCommand(["acrossfade"], "[mix][end_chime]", null, 3, "mix")
      );
  ...
  proto.runLoudnormAac = function (
    ...
    return new Promise((resolve, reject) => {
      ...
      if (params.input_i > -17.5) {
        filter = `volume=-${parseFloat(data.input_i) + 17.5}dB`;
      }
      ffmpeg(input)
