...
const ERROR_CODE = Object.freeze({
  ...
  E0001262: "テキストの最大文字数は800文字までです。",
  E0001270: "話者指定に不備があります。",
  E0001280: "言語指定に不備があります。",
  E0001290: "原稿に不備があります。",
  E0001291: "原稿に設定できない文字が含まれています。",
  E0001292: "原稿の最大文字数は2000文字までです。",
  // cm status
  ...
  E0300010:
    "CMの作成で利用されているため、削除できません。CMの利用を解除するか、CMを削除してください。",

  // external E04
  E0400000: "外部連携でエラーが発生しました。",
  E0400010:
    "既に外部連携データが存在しているため、アップロードできません。しばらくお待ちください。",
});
