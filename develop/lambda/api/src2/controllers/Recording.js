...
module.exports.createUserRecording = function createUserRecording (req, res, next, xUnisCustomerCd, xToken) {
  Recording.createUserRecording(xUnisCustomerCd, xToken)
...
module.exports.listUserRecording = function listUserRecording (req, res, next, xUnisCustomerCd, xToken, sort) {
  Recording.listUserRecording(xUnisCustomerCd, xToken, sort)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
