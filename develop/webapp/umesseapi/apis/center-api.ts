...
export const CenterApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createCenterCm: async (cmId: string, body?: Body3, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteCenterCm: async (cmId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'cmId' is not null or undefined
            if (cmId === null || cmId === undefined) {
         ...
         * @throws {RequiredError}
         */
        getCenterUpload: async (options: any = {}): Promise<RequestArgs> => {
...
export const CenterApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createCenterCm(cmId: string, body?: Body3, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await CenterApiAxiosParamCreator(configuration).createCenterCm(cmId, body, options);
         ...
         * @throws {RequiredError}
         */
        async deleteCenterCm(cmId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await CenterApiAxiosParamCreator(configuration).deleteCenterCm(cmId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getCenterUpload(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InlineResponse200>>> {
            const localVarAxiosArgs = await CenterApiAxiosParamCreator(configuration).getCenterUpload(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CenterApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createCenterCm(cmId: string, body?: Body3, options?: any): AxiosPromise<void> {
            return CenterApiFp(configuration).createCenterCm(cmId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary CMセンター連携削除
         ...
         * @throws {RequiredError}
         */
        deleteCenterCm(cmId: string, options?: any): AxiosPromise<void> {
            return CenterApiFp(configuration).deleteCenterCm(cmId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary センターCM連携（センター専用）
         ...
         * @throws {RequiredError}
         */
        getCenterUpload(options?: any): AxiosPromise<Array<InlineResponse200>> {
            return CenterApiFp(configuration).getCenterUpload(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary センターCM連携完了（センター専用）
...
export class CenterApi extends BaseAPI {
     ...
     * @memberof CenterApi
     */
    public createCenterCm(cmId: string, body?: Body3, options?: any) {
        return CenterApiFp(this.configuration).createCenterCm(cmId, body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary CMセンター連携削除
     ...
     * @memberof CenterApi
     */
    public deleteCenterCm(cmId: string, options?: any) {
        return CenterApiFp(this.configuration).deleteCenterCm(cmId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary センターCM連携（センター専用）
     ...
     * @memberof CenterApi
     */
    public getCenterUpload(options?: any) {
        return CenterApiFp(this.configuration).getCenterUpload(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary センターCM連携完了（センター専用）
