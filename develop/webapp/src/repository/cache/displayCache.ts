...
export const DISPLAY_CACHE_KEY = {
  ...
  VOICE_TEMPLATE_INDEX_NARRATION_SCROLL_POSITION: "VOICE_TEMPLATE_INDEX_NARRATION_SCROLL_POSITION",
  ...
  VOICE_FREE_INDEX_SELECT_SPEAKER: "VOICE_FREE_INDEX_SELECT_SPEAKER",
} as const;
