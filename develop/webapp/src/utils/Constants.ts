...
export const ERROR_PATTERN = {
  // アプリ起因
  "A0001": "データの取得に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  // API起因
  "A3000": "サーバーへの接続に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  "A3001": "サーバーの認証に失敗しました。",
  "A3002": "データの取得に失敗しました。通信環境をご確認ください。",
  "A3999": "サーバーへの接続に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  // 認証起因
  "A4000": "サーバーへの接続に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  "A4001": "サーバーの認証に失敗しました。",
