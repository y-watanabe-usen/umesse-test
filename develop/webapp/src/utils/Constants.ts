...
export default class Constants {
  ...
  public static readonly DESCRIPTION_MAX_LENGTH: number = 400;
  public static readonly TTS_FREE_MAX_LENGTH: number = 500;
  public static readonly STORE_NAME_MAX_LENGTH: number = 30;
}
...
export const ERROR_PATTERN = {
  ...
  A4000:
    "サーバーへの接続に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  A4001:
    "認証に失敗しました。アプリケーションを再起動してください。それでも直らない場合はお手数ですが○○までお問い合わせください。",
  A4002:
    "認証に失敗しました。アプリケーションを再起動してください。それでも直らない場合はお手数ですが○○までお問い合わせください。",
  A4004: "認証に失敗しました。契約内容をご確認ください。",
  A4999:
    "サーバーへの接続に失敗しました。通信環境をご確認の上、リロードボタンを押してください。",
  // 想定外エラー
