...
describe("getManagementScenesのテスト", () => {
  const expected = [{ cd: '001', name: 'チャイム' }, { cd: '002', name: 'ブザー' }, { cd: '003', name: '効果ＢＧＭ' }, { cd: '004', name: '開店' }, { cd: '005', name: '閉店' }, { cd: '007', name: '案内' }, { cd: '008', name: '年末営業告知' }, { cd: '009', name: '年始営業告知' }, { cd: '010', name: '年中行事販促' }, { cd: '011', name: '時報' }, { cd: '012', name: '営業時間案内' }, { cd: '013', name: '駐車場' }, { cd: '014', name: 'カード' }, { cd: '015', name: '注意・禁止' }, { cd: '016', name: 'スタッフコール' }, { cd: '017', name: '呼び出し' }, { cd: '018', name: '防犯' }, { cd: '019', name: 'エコ推奨' }, { cd: '020', name: 'ＡＴＭ注意事項' }, { cd: '021', name: '体操' }, { cd: '022', name: 'セール' }, { cd: '023', name: '起床・消灯' }, { cd: '024', name: '食事' }, { cd: '025', name: '入浴' }, { cd: '026', name: '面会' }, { cd: '027', name: '受付' }, { cd: '028', name: '診察' }, { cd: '029', name: '回診' }, { cd: '030', name: 'イベント' }, { cd: '031', name: 'レクリエーション' }, { cd: '032', name: '検診案内' }, { cd: '033', name: '通年健康情報' }, { cd: '034', name: '季節健康情報' }, { cd: '035', name: '歯科向け' }, { cd: '036', name: 'バス時間' }, { cd: '037', name: '朝礼・終礼' }, { cd: '038', name: '業務時間' }, { cd: '039', name: '作業時間' }, { cd: '040', name: '休憩・昼休み' }, { cd: '041', name: '集荷時間' }, { cd: '042', name: '会議' }, { cd: '043', name: '工場見学' }, { cd: '044', name: '身なり・衛生' }, { cd: '045', name: '整理・清掃' }, { cd: '046', name: '注意・心がけ' }, { cd: '047', name: '禁止事項' }, { cd: '048', name: '催事' }, { cd: '049', name: '風営法' }, { cd: '050', name: '営業開始案内' }, { cd: '051', name: '営業終了案内' }, { cd: '052', name: 'コロナ関連' }, { cd: '901', name: '録音' }, { cd: '902', name: '音声合成' },];
  test(`全シーン一覧が返ること`, () => {
