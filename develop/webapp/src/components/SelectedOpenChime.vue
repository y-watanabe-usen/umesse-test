<template>
  <div class="selected-open-chime">
    ...
    <p>チャイム01</p>
    <div class="open-chime-middle">
      <svg width="2.7em" height="2.7em" viewBox="0 0 16 16" class="bi bi-music-note-list" fill="#808080" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="open-chime-under">
      <div class="open-chime-under-left">
      ...
      <div class="open-chime-under-center"></div>
      <div class="open-chime-under-right">
        <div class="open-chime-dot">
...
.open-chime-under-left {
  width: 25%;
  border-radius: 10px;
  text-align: center;
  margin-top: 3px;
}
.open-chime-under-center {
  width: 50%;
  border-radius: 10px;
  margin-top: 10px;
  text-align: center;
}
.open-chime-under-right {
  width: 25%;
  border-radius: 10px;
}
.open-chime-dot {
