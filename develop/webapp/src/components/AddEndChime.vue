<template>
  <button class="end-chime"  data-toggle="modal" data-target="#modal-end-chime">
    <div class="btn-area">
  ...
  <!-- Modal -->
  <div
    class="modal fade modal-end-chime"
    id="modal-end-chime"
    tabindex="-1"
    role="dialog"
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <button
                          type="button" v-on:click="selectedEndChime()"
