<template>
  <div class="selected-end-chime">
    ...
    <div class="end-chime-under">
      <div class="end-chime-under-left">
      ...
      <div class="end-chime-under-center"></div>
      <div class="end-chime-under-right">
        <div class="end-chime-dot">
...
.end-chime-under-left {
  width: 25%;
  border-radius: 10px;
  text-align: center;
  margin-top: 3px;
}
.end-chime-under-center {
  width: 50%;
  border-radius: 10px;
  margin-top: 10px;
  text-align: center;
}
.end-chime-under-right {
  width: 25%;
  border-radius: 10px;
}
.end-chime-dot {
