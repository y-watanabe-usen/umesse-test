...
| 区分 | CM削除 | CM作成中 | CM作成完了 | CMエンコード中 | CM共有中 | CM生成中 | CM作成エラー | 外部システムアップロード中 | 外部システムアップロード完了 | 外部システムアップロードエラー |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CM削除 | - | - | - | - | - | - | - | - | - | - |
| CM作成中 | 〇 | - | - | 〇 | - | - | - | - | - | - |
| CM作成完了 | 〇 | - | 〇 | - | 〇 | - | - | 〇 | - | - |
...
※CM削除、CM作成エラー、外部システムアップロードエラーの場合は基本的に手動する予定（要検討）

### ステータスによる機能区分

| 区分 | 試聴 | タイトル/説明編集 | コンテンツ編集 | アップロード | アップロード解除 | 削除 |
| --- | --- | --- | --- | --- | --- | --- |
| CM削除 | - | - | - | - | - | - | - |
| CM作成中 | - | 〇 | 〇 | - | - | 〇 |
| CM作成完了 | 〇 | 〇 | 〇 | 〇 | - | 〇 |
...
| CM作成エラー | - | - | - | - | - | - |
| 外部システムアップロード中 | 〇 | - | - | - | - | - |
| 外部システムアップロード完了 | 〇 | 〇 | - | - | 〇 | - |
| 外部システムアップロードエラー | - | - | - | - | - | - |

※CM削除は画面表示しない
※CM作成エラー、外部システムアップロードエラーの場合は要検討
